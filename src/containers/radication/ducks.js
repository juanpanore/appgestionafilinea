...
const SEARCH_DOC_TYPES_DATA_IN_PROGRESS = "payments/bills-settlement/SEARCH_DOC_TYPES_DATA_IN_PROGRESS";
...
export default createReducer(initialState, {
    ...
    [SEARCH_DOC_TYPES_DATA_IN_PROGRESS]: state => state.set("loadingDocTypes", true).set("docTypes", []),
